...
const App = () => {
  return (
    <>
      <main className="relative transition-all ease-in-out duration-200">
     ...
     <Navbar/>
        ...
        <section className="p-4 py-7 space-y-5  ">
          ...
          <div className=" grid grid-cols-1 lg:w-[80%] mx-auto md:grid-cols-2 lg:grid-cols-3  md:mt-12 gap-9 mt-3 sm:p-5 ">
            {/* image  div 1 */}
            <div className="bg-gradient-to-b z-[-1] lg:hover:scale-105 transition-all duration-300 ease-in-out relative from-[#c00ff9]   flex flex-col justify-around rounded-xl to-[#5037e6]  ">
              {/* info div  */}
            ...
            {/* image div 2  */}
            <div className="bg-gradient-to-b z-[-1] lg:hover:scale-105 transition-all duration-300 ease-in-out relative from-[#4da7fa]   flex flex-col justify-around rounded-xl to-[#604cef]  ">
              {/* info div  */}
        ...
        <footer className="py-8 flex flex-col lg:flex-row justify-between  w-[80%] mx-auto  lg:px-4 gap-1  items-center">
          <div className="flex items-center gap-1 ">
            ...
            <img
              ...
              alt=""
            />{" "}
            <h1 className="text-sm  font-bold">The everything app for work</h1>
          </div>
          <div className="flex items-center gap-4 text-gray-500 font-semibold  text-sm">
            <span>Security</span>
            <span>Privacy</span>
            <span>Terms</span>
            <span>@2025 Click up</span>
          </div>
        </footer>
      </main>
    </>
