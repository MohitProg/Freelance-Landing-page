...
const ContactForm = () => {
  return (
    <section className="w-full p-3  md:p-0   mt-10 lg:mt-30  lg:w-[80%] rounded-lg mx-auto grid grid-cols-1 md:shadow-md  md:grid-cols-2 md:border-[1px] gap-10 border-gray-200 overflow-hidden  ">
