...
const ContactForm = () => {
  return (
    <section className="w-full  mt-30  lg:w-[80%] rounded-lg mx-auto grid grid-cols-1 md:shadow-lg  md:grid-cols-2 md:border-[2px] gap-10 border-gray-300 overflow-hidden  ">
